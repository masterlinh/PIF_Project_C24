...
void ArrayInput(uint8_t array_enter[], int size)
{
...
void ArrayPrint(uint8_t array_enter[], int size)
{
    printf("arr[] = { ");
    for(int i=0;i<size;i++)
    {
...
void ArrayPrintAddress(uint8_t array_enter[], int size)
{
