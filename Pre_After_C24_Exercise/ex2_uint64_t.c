...
void ArrayInput(uint64_t array_enter[], int size)
{
...
void ArrayPrint(uint64_t array_enter[], int size)
{
    printf("arr[] = { ");
    for(int i=0;i<size;i++)
    {
...
void ArrayPrintAddress(uint64_t array_enter[], int size)
{
